    ...
    >
      <div className="p-4">
        ...
        <img
          ...
          height="100"
        />
        <p><strong>WhatsApp:</strong> <a href={business.contactLinks.whatsapp} target="_blank" rel="noopener noreferrer">WhatsApp</a></p>
        ...
        <p><strong>Industry:</strong> {business.industryName}</p>
        <p><strong>Catalog:</strong> {business.catalog ? (
          <a href={`http://localhost:3002/pdf/download/${business.catalog}`} download>
            Download Catalog
          </a>
        ) : (
